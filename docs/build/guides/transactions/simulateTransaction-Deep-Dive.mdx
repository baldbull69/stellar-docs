...
- [openRpc Documentation](https://developers.stellar.org/network/stellar-rpc/api-reference/methods/simulateTransaction)
- [openRpc json Specification](https://github.com/stellar/stellar-docs/blob/main/static/openrpc.json)
- [preflight.go](https://github.com/stellar/stellar-rpc/blob/release/v21.0.0/cmd/stellar-rpc/internal/preflight/preflight.go)
