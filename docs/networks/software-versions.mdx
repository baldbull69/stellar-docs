...
- Repoint soroban-spec-tools to the moved one in stellar/stellar-rpc
...
The Stellar RPC version for Preview 11 is presently in Stellar's unstable and testing apt repositories. Additionally, its Docker image release can be accessed at [docker.io/stellar/stellar-rpc:20.0.0-rc3-39](https://hub.docker.com/layers/stellar/stellar-rpc/20.0.0-rc3-39/images/sha256-227170869bca74998e1b6cc1e07deb3aca8d03e36154b3da700d6669e19d485b?context=explore).
